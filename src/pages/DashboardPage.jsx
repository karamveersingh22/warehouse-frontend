...
export default function DashboardPage() {
  ...
  const totalInventory = products.reduce((s, p) => s + Number(p.total_inventory ?? 0), 0)
  const lowStock       = products.filter(p => Number(p.total_inventory ?? 0) <= 10).length
    ...
    <div className="min-h-screen bg-ink-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-6 md:sticky md:top-24 self-start">

            {/* Stats */}
            {!loading && (
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-2 gap-3 animate-fadeUp-delay-1">
                {[
          ...
          {/* Right panel */}
          <div className="md:col-span-8 animate-fadeUp-delay-3">
